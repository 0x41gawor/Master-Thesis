...
Po pierwsze Lupus ma przyjąć rolę \hyperlink{def:regulator}{\textit{regulatora}} (ang. \textit{Control System}) znanego z teorii sterowania. Regulowanymi systemami mają być w tym przypadku systemy telekomunikacyjne. Aby odegrać rolę \hyperlink{def:system-eni}{\textit{Systemu ENI}}, platforma musi być w stanie zamodelować oraz uruchomić \underbar{dowolną} zamkniętą pętlę sterowania, zwłaszcza te zawarte w \cite{enioverview}. 
