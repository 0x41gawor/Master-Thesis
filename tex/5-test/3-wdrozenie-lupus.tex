...
Implementacje można znaleźć w \hyperref[appendix://TODO]{załączniku}.
...
Kod \hyperlink{def:lupn}{\textbf{LupN}} znajduje się w \hyperref[appendix://TODO]{załączniku}. Ostatnim krokiem w celu uruchomienia pętli jest zaaplikowanie \hyperlink{def:plik-lupn}{\textbf{Pliku LupN}}.
